  ...
  <AppLayout>
    ...
    <div class="profiles">
      <div
        ...
        v-for="(userprofile, key) in usersprofile.data"
        :key="key"
      >
        <img
          class="round-img"
        ...
        <div>
          ...
          <Link
            :href="route('usersprofile.show', userprofile.id)"
        ...
        <ul>
          <li
            class="text-primary"
            v-for="(skill, skillkey) in userprofile.user_skills"
            :key="skillkey"
          >
      ...
      <pagination :links="usersprofile.links" />
    </div>
  </AppLayout>
</template>
<script>
